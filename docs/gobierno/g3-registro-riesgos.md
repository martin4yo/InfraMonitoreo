...
- **Total:** **23** riesgos operativos/gobierno (**3 cerrados**: R18, R21, R22) + 4 escenarios de desastre. *(2026-09-03: **+R23**, encontrado en un spot-check contra los servers: dev-1 20 días sin firewall de host.)* *(2026-08-12: **+R21**, el único que se descubrió **ejecutando** y no leyendo. 2026-08-09: +8 — R13 a R20,
...
- **🟡 Medio:** R02, R06, R09, R10, R11, R12, **R16**, **R17**, **R19**, **R23**, RD-B, RD-C, RD-D.
