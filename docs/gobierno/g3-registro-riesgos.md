...
- **Total:** **21** riesgos operativos/gobierno (**1 cerrado**: R21) + 4 escenarios de desastre. *(2026-08-12: **+R21**, el único que se descubrió **ejecutando** y no leyendo. 2026-08-09: +8 — R13 a R20,
...
- **🔴 Alto:** R08 (bus factor de ejecución), **R13** (posibles datos productivos 🔴 en dev-1),
  **R14** (el blocklist del db-agent no protege datos clínicos — **verificado**), **R18** (cambio de sshd latente), **R20** (acceso administrativo del
